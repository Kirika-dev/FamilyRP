const DoorsDynamicData = { // Массив дверей, с которыми мы хотим потом работать с сервера
    // Двери PD
    "pd_0": {
        id: 0,
    ...
    "ballas_1": {
        ...
        toggled: false,
        position: new mp.Vector3(115.0443, -1961.40, 21.4661)
    },
    "ballas_2": {
        id: 345,
        hash: mp.game.joaat ('v_ilev_bk_door'),
    ...
    "jud_1": {
        id: 166,
        hash: mp.game.joaat ('q_jud_door'), // начало дверей суда
        toggled: false,
    ...
    "vag_0": {
        ...
        hash: mp.game.joaat ('v_ilev_ra_door4l'),
        toggled: false,
        position: new mp.Vector3(1436.536, -1491.194, 63.77628)
    },
    "vag_1": {
        id: 274,
        hash: mp.game.joaat ('v_ilev_ra_door4l'),
        toggled: false,
        position: new mp.Vector3(1438.636, -1491.846, 63.77628)
    },
    "vag_2": {
        id: 275,
        hash: mp.game.joaat ('v_ilev_ra_door4l'),
        toggled: false,
        position: new mp.Vector3(1434.761, -1490.758, 66.79662)
    },
    "vag_3": {
        id: 276,
        hash: mp.game.joaat ('v_ilev_ra_door4l'),
        toggled: false,
        position: new mp.Vector3(1436.869, -1491.396, 66.79662)
    },
    "vag_4": {
        id: 277,
        hash: mp.game.joaat ('v_ilev_ra_door4l'),
        toggled: false,
        position: new mp.Vector3(1439.33, -1480.502, 63.78523)
    },
    "vag_5": {
        id: 278,
        hash: mp.game.joaat ('apa_p_mp_door_mpa2_frnt'),
        toggled: false,
        position: new mp.Vector3(1441.88, -1487.61, 63.77902)
    },
    "vag_6": {
        id: 279,
        hash: mp.game.joaat ('apa_p_mp_door_mpa2_frnt'),
        toggled: false,
        position: new mp.Vector3(1442.764, -1482.856, 66.78407)
    },
    // bloods
    "blood_0": {
        id: 280,
        hash: mp.game.joaat ('pablito_lvabar_door2'),
        toggled: false,
        position: new mp.Vector3(493.0992, -1541.718, 29.48248)
    },
    "blood_1": {
        id: 281,
        hash: mp.game.joaat ('pablito_lvabar_door1'),
        toggled: false,
        position: new mp.Vector3(486.8262, -1529.501, 29.52529)
    },
    "blood_2": {
        id: 282,
        hash: mp.game.joaat ('v_ilev_cm_door1'),
        toggled: false,
      ...
      "mara_0": {
        id: 283,
        hash: mp.game.joaat ('apa_prop_heist_cutscene_doorb'),
        toggled: false,
        position: new mp.Vector3(942.1108, -2158.998, 31.41879)
    },
    "mara_1": {
        id: 284,
        hash: mp.game.joaat ('v_ilev_cm_door1'),
        toggled: false,
        position: new mp.Vector3(952.8176, -2162.298, 31.43412)
    },
    "mara_2": {
        id: 285,
        hash: mp.game.joaat ('v_ilev_cm_door1'),
        toggled: false,
        position: new mp.Vector3(943.2896, -2153.556, 31.42768)
    },
    "army_22": {
        id: 286,
        hash: mp.game.joaat ("bmjr_block_gate"),
        toggled: true,
        position: new mp.Vector3(-2323.495, 3392.751, 30.12666)
    },
    "army_23": {
        id: 287,
        hash: mp.game.joaat ("bmjr_block_gate"),
        toggled: true,
        position: new mp.Vector3(-2314.485, 3405.073, 30.13932)
    },
    "army_24": {
        id: 288,
        hash: mp.game.joaat ("bmjr_block_gate"),
        toggled: true,
        position: new mp.Vector3(-1569.503, 2784.424, 16.93626)
    },
    "army_25": {
        id: 289,
        hash: mp.game.joaat ("bmjr_block_gate"),
        toggled: true,
        position: new mp.Vector3(-1580.521, 2773.849, 16.87911)
    },
    "army_26": {
        id: 290,
        hash: mp.game.joaat ("fluorine4305_bollard_02"),
        toggled: false,
        position: new mp.Vector3(-1590.81665, 2793.07837, 14.4444895)
    },
    "army_27": {
        id: 291,
        hash: mp.game.joaat ("fluorine4305_bollard_02"),
        toggled: false,
        position: new mp.Vector3(-1595.13354, 2789.505, 14.2615585)
    },
    "army_28": {
        id: 292,
        hash: mp.game.joaat ("fluorine4305_bollard_02"),
        toggled: false,
        position: new mp.Vector3(-1583.61743, 2799.44727, 14.3025675)
    },
    "army_29": {
        id: 293,
        hash: mp.game.joaat ("fluorine4305_bollard_02"),
        toggled: false,
        position: new mp.Vector3(-1587.928, 2795.68677, 14.4546747)
    },
};

global.DoorsDynamicDataToDist = {};

gm.events.add("doorControl", (index, toggled) => { // Устанавливаем какой-то двери статус отдельно
	try
	{
        if (DoorsDynamicData[index] && DoorsDynamicData[index].hash) {
            DoorsDynamicData[index].toggled = toggled;
            mp.game.object.doorControl(DoorsDynamicData[index].hash,
                DoorsDynamicData[index].position.x, DoorsDynamicData[index].position.y, DoorsDynamicData[index].position.z,
                DoorsDynamicData[index].toggled, 0.0, 0.0, 0.0);
	...
	{
		mp.events.callRemote("client_trycatch", "world/doors", "doorControl", e.toString());
	}
});

gm.events.add("doorsControl", (json) => { // Устанавливаем при входе статус всех дверей
	try {
        json = JSON.parse (json);
        
        for (let key in json) {
            if (typeof json[key] === "undefined" || typeof DoorsDynamicData[key] === "undefined")
                continue;
            
            DoorsDynamicData[key].toggled = json[key];

            mp.game.object.doorControl(DoorsDynamicData[key].hash,
                DoorsDynamicData[key].position.x, DoorsDynamicData[key].position.y, DoorsDynamicData[key].position.z,
                DoorsDynamicData[key].toggled, 0.0, 0.0, 0.0);
        }
        GetDistDoors ();
	}
	catch (e) 
	{
		mp.events.callRemote("client_trycatch", "world/doors", "doorsControl", e.toString());
	}
});
...
const GetDistDoors = () => {
    try {
        ...
        let dist;
        let newObjectData = {};
        for (let key in DoorsDynamicData) {
            doorData = DoorsDynamicData [key];
            if (doorData.hash) {
                ...
                if (dist < 50) {
                    newObjectData [key] = doorData;
                }
            }
        }
        global.DoorsDynamicDataToDist = newObjectData;
    }
	catch (e) 
	{
		mp.events.callRemote("client_trycatch", "world/doors", "GetDistDoors", e.toString());
	}
}
...
/*
global.getEntityCapsule = (flags = global.RAYCASTING_FLAGS.map | global.RAYCASTING_FLAGS.objects) => {//Не использую
	...
	const { x: xPos, y: yPos, z: zPos } = mp.players.local.position,
		...
		testCapsule = mp.raycasting.testCapsule(front_vector, right_vector, 0.5, mp.players.local, flags);

	if (testCapsule) {
		//if (testCapsule.entity.type === void(0))
		//	return null;

		return testCapsule.entity;
	}
	return null;
}

gm.events.add(global.renderName ["150ms"], () => {
    mp.gui.chat.push("testCapsule 0");
    const testCapsule = global.getEntityCapsule ();

    mp.gui.chat.push("testCapsule 1");
    ...
    if (testCapsule) {         
        ...
        mp.gui.chat.push("testCapsule 2");


        if ("object" == typeof testCapsule) {
            entity = testCapsule.handle;
            model = testCapsule.model;
            //model = global.utils.fixHash(testCapsule.entity.model);
        } else if ("number" == typeof testCapsule && testCapsule !== 0 && nativeInvoke("IS_ENTITY_AN_OBJECT", testCapsule)) {
            entity = testCapsule;
            model = global.utils.fixHash(nativeInvoke("GET_ENTITY_MODEL", testCapsule));
        }



        mp.gui.chat.push("testCapsule 3");



        const pPos = global.localplayer.position;  
        const selectDist = global.vdist2(pPos, Natives.GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(entity, pPos.x, pPos.y, pPos.z));

        if (hoverObject != null) {
            const hoverDist = global.vdist2(pPos, Natives.GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(hoverObject.entity, pPos.x, pPos.y, pPos.z));
            if (hoverDist > selectDist)
                return;
        }

        mp.gui.chat.push("testCapsule 4");

        const index = Object.values (DoorsDynamicDataToDist).findIndex(d => d.hash == model && global.vdist2(pPos, d.position) < 3.5);
        const key = Object.keys (DoorsDynamicDataToDist) [index];

        mp.gui.chat.push("testCapsule 5");

        if (DoorsDynamicDataToDist [key]) {
            mp.gui.chat.push("testCapsule 6");
            hoverObject = DoorsDynamicDataToDist [key];
            hoverObject.model = model;
            hoverObject.entity = entity;
            return;
        }
        hoverObject = null;
    }
...
gm.events.add("render", () => {
    if (hoverObject != null) {
        ...
        let worldCoords = getDimensionsModel (hoverObject.model);

        worldCoords = Natives.GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(hoverObject.entity, worldCoords.x, worldCoords.y, worldCoords.z)

        worldCoords = mp.game.graphics.world3dToScreen2d(worldCoords);

        const scale = 1.25
        global.DrawSprite("redage_textures_001", "door_open", [255, 255, 255, 255], worldCoords.x, worldCoords.y);
    }
});*/
        ...
        /*if (hoverObject != null) {
            ...
            const scale = 1.25
            global.DrawSprite("redage_textures_001", "zamok", [255, 255, 255, 255], worldCoords.x, worldCoords.y);
        }*/
...
//mp.gui.chat.push("testCapsule - " + JSON.stringify (testCapsule));
if (testCapsule) {
    ...
    if ("object" == typeof testCapsule.entity) {
        ...
        model = global.utils.fixHash(Natives.GET_ENTITY_MODEL(testCapsule.entity));
    }

    mp.gui.chat.push("entity 1 - " + JSON.stringify (testCapsule.entity));
    if (Object.values (DoorsDynamicDataToDist).findIndex(d => d.hash == model) != -1) {
        const { x: xPos, y: yPos, z: zPos } = mp.players.local.position;
        let worldCoords = Natives.GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(entity, xPos, yPos, zPos);

        const dimensions = mp.game.gameplay.getModelDimensions(model);
        const xAbs = (Math.abs(dimensions.min.x) + Math.abs(dimensions.max.x));
        const yAbs = (Math.abs(dimensions.max.y) - Math.abs(dimensions.min.y));
        const zAbs = (Math.abs(dimensions.min.y) + Math.abs(dimensions.max.y));


        worldCoords = new mp.Vector3(xAbs, yAbs, zAbs)

        worldCoords = Natives.GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(entity, worldCoords.x, worldCoords.y, worldCoords.z)

        const pos = mp.game.graphics.world3dToScreen2d(worldCoords);

        const scale = 1.25
        global.DrawSprite("redage_textures_001", "zamok", [255, 255, 255, 255], pos.x, pos.y);
    }
}
...
const getDimensionsModel = (model) => {
    const dimensions = mp.game.gameplay.getModelDimensions(model);
    ...
    return new mp.Vector3(xAbs, yAbs, zAbs);
}
...
gm.events.add("render", () => {
    ...
    //
    const localPos = global.localplayer.position;
    Object.values (DoorsDynamicDataToDist).forEach((DoorData) => {
        if (DoorData.hash) {
            const dist = mp.game.system.vdist(DoorData.position.x, DoorData.position.y, DoorData.position.z, localPos.x, localPos.y, localPos.z);
            if (dist <= 2.5) {
                const pos = mp.game.graphics.world3dToScreen2d(DoorData.position.x, DoorData.position.y, DoorData.position.z);
                if (!pos) {
                    return false;
                }

                global.DrawSprite("redage_textures_001", !DoorData.toggled ? "door_open" : "door_close", [255, 255, 255, 255], pos.x, pos.y);
            }
        }
    });
});

const DoorsStaticData = [
    {
    ...
    }, // 
    {
        ...
        toggled: false
    }, // Блокируем Дверь в low доме
    {
        hash: "v_ilev_trevtraildr",
        position: new mp.Vector3(1972.769, 3815.366, 33.66326),
        toggled: false
    }, // Блокируем Дверь у Трэвора
    {
        hash: "prop_ld_bankdoors_02",
        position: new mp.Vector3(232.6054, 214.1584, 106.4049),
        toggled: false
    }, // Блокируем двери в интерьере банка (Мерии)
    {
        hash: "prop_ld_bankdoors_02",
        position: new mp.Vector3(231.5075, 216.5148, 106.4049),
        toggled: false
    }, // Блокируем двери в интерьере банка (Мерии)
    ...
    }, // Задний выход
    {
        ...
        toggled: false
    }, // Проход за стойку (Решетчатая дверь)
    {
...
setTimeout(() => {
    DoorsStaticData.forEach((DoorData) => {
        mp.game.object.doorControl(mp.game.joaat(DoorData.hash),
            DoorData.position.x, DoorData.position.y, DoorData.position.z,
