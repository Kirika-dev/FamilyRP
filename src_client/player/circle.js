...
const categoryData = {
	[translateText("Я")]: ["inv", "phone", "fraction_table", "org_table", "anim", "battlepass", "donate", "documents"],
	//
			...
			case translateText("Документы"):
				...
				switch (index) {
					...
					case 5:
						...
						return;
					case 6: // Добавьте новый случай для отображения паспорта самому себе
                        global.showMyPassport();
                        return;
				}
				return;
