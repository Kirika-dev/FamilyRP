    ...
    <div class="weazelnews__planshet">
        ...
        <div class="box-flex w-100">
            <div class="weazelnews__nav">
                ...
                <div class="line"></div>
                <div class="weazelnews__nav_element mt-24" class:active={selectView === "Gov"} on:click={() => selectView = "Gov"} on:keydown={(e) => e.key === 'Enter' && (selectView = "Gov")}>
                    <span class="bortovoiicon-news"></span>
                    <div class="weazelnews__nav_text">Государственная волна</div>
                </div>
                <div class="weazelnews__nav_element mt-24" class:active={selectView === "Ads" || selectView === "List"} on:click={() => selectView = "List"} on:keydown={(e) => e.key === 'Enter' && (selectView = "List")}>
                ...
                <div class="weazelnews__nav_element" class:active={selectView === "Live"} on:click={() => selectView = "Live"} on:keydown={(e) => e.key === 'Enter' && (selectView = "Live")}>
