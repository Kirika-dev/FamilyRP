...
namespace NeptuneEvo.Functions
{
    ...
    public static class AdminCommands
    {
        ...
        public const string TestBeard = "testbeard";
        ...
        public const string Createfracveh = "createfracveh";
    ...
    class CommandsAccess : Script
    {
        ...
        public static string[] LoginsDirector = new string[3] { "magicpika", "ivan228", "kirkaha" };
