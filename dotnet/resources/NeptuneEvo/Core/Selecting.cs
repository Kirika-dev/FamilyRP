        ...
        public static void CallPoliceHijack(ExtPlayer player, byte type, string vnumber)
        {
            try
            {
                ...
                if (type == 0)
                {
                    ...
                    {
                        Police.setPlayerWantedLevel(player, new Character.Models.WantedLevel(5, LangFunc.GetText(LangType.Ru, DataName.Police), DateTime.Now, LangFunc.GetText(LangType.Ru, DataName.ReasonHijackHouse)));
                ...
                else
                {
                    ...
                    {
                        Police.setPlayerWantedLevel(player, new Character.Models.WantedLevel(5, LangFunc.GetText(LangType.Ru, DataName.Police), DateTime.Now, LangFunc.GetText(LangType.Ru, DataName.ReasonHijackVeh)));
                        Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.SignalSrabotalWanted), 3000);
                    }
                    else Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.SignalSrabotal), 1000);
                }
