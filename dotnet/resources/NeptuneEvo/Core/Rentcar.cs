...
namespace NeptuneEvo.Core
{
    ...
    class Rentcar : Script
    {
        ...
        public static RentCarData[] RentCarsData =
        {
            ...
            new RentCarData(93, "taxi2", 100, new List<RentCarId>() { RentCarId.JobTaxi }, JobsId.Taxi), 
            ...
            // 
           new RentCarData(96,"1969liaz667", 10, new List<RentCarId>() { RentCarId.JobBus }, JobsId.Bus),
            new RentCarData(97, "citiport", 10, new List<RentCarId>() { RentCarId.JobBus }, JobsId.Bus), 
            new RentCarData(98, "bus", 15, new List<RentCarId>() { RentCarId.JobBus }, JobsId.Bus), 
            new RentCarData(99, "coach", 20, new List<RentCarId>() { RentCarId.JobBus }, JobsId.Bus), 
 
            // 
            new RentCarData(100, "gazel", 100, new List<RentCarId>() { RentCarId.JobTrucker }, JobsId.Trucker), 
            new RentCarData(101, "FH500", 250, new List<RentCarId>() { RentCarId.JobTrucker }, JobsId.Trucker), 
            new RentCarData(102, "rallytruck", 750, new List<RentCarId>() { RentCarId.JobTrucker }, JobsId.Trucker), 
 
            // 
            new RentCarData(103, "sberbank", 10, new List<RentCarId>() { RentCarId.JobCollector }, JobsId.CashCollector),
            new RentCarData(104, "terbyte", 15, new List<RentCarId>() { RentCarId.JobCollector }, JobsId.CashCollector), 
            new RentCarData(105, "rallytruck", 20, new List<RentCarId>() { RentCarId.JobCollector }, JobsId.CashCollector), 
 
            // 
            new RentCarData(106, "caracara2", 10, new List<RentCarId>() { RentCarId.JobMechanic }, JobsId.CarMechanic), 
             
            // 
            new RentCarData(107, "2004gaz3309", 10, new List<RentCarId>() { RentCarId.JobPostman }, JobsId.Postman),
            //
            new RentCarData(108, "pounder", 0, new List<RentCarId>() { RentCarId.JobCargo }, JobsId.CargoDelivery), 
            new RentCarData(109, "pounder2", 0, new List<RentCarId>() { RentCarId.JobCargo }, JobsId.CargoDelivery), 
            new RentCarData(110, "rallytruck", 0, new List<RentCarId>() { RentCarId.JobCargo }, JobsId.CargoDelivery),  
        };
        ...
        private static RentCarSpawn[] RentCarsSpawn = new RentCarSpawn[]
       {
        ...
        private static IReadOnlyDictionary<RentCarId, RentBlipData> RentBlipsData = new Dictionary<RentCarId, RentBlipData>()
        {
           ...
           { RentCarId.JobTaxi, new RentBlipData(2, LangFunc.GetText(LangType.Ru, DataName.Taxi), 46) },
            ...
            { RentCarId.JobCargo, new RentBlipData(2, LangFunc.GetText(LangType.Ru, DataName.CargoDelivery), 4) },
        ...
        public static void RentCarToInterface(ExtPlayer player, int carId, int colorId, int hour)
        {
            try
            {
                ...
                switch (rentCarsData.Job)
                {
                    case JobsId.Taxi:
                        ...
                        if (jobLevelInfo.Item1 <= 1 && rentCarsData.Model != "taxi" ||
                            jobLevelInfo.Item1 >= 2 && rentCarsData.Model != "taxi2" && jobLevelInfo.Item1 <= 4 && rentCarsData.Model != "bmwm5")
                        {
                    ...
                    case JobsId.Trucker:
                        ...
                        if (jobLevelInfo.Item1 <= 1 && rentCarsData.Model != "gazel" ||
                            jobLevelInfo.Item1 >= 2 && jobLevelInfo.Item1 <= 3 && rentCarsData.Model != "FH500" && rentCarsData.Model != "benson" && rentCarsData.Model != "gemera")
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model, jobLevelInfo.Item1), 8000);
                            return;
                        }
                    ...
                    case JobsId.CargoDelivery:
                        ...
                        if (characterData.WorkID != (int)JobsId.CargoDelivery)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.BeforeNeedToWork), 3000);
                            return;
                        }
                        ...
                        jobLevelInfo = characterData.JobSkills.ContainsKey((int)JobsId.CargoDelivery) ? Main.GetPlayerJobLevelBonus((int)JobsId.CargoDelivery, characterData.JobSkills[(int)JobsId.CargoDelivery]) : (0, 1);
                        if (jobLevelInfo.Item1 <= 1 && rentCarsData.Model != "gazel" ||
                            jobLevelInfo.Item1 >= 2 && jobLevelInfo.Item1 <= 3 && rentCarsData.Model != "FH500" && rentCarsData.Model != "benson" && rentCarsData.Model != "gemera")
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model, jobLevelInfo.Item1), 8000);
                    ...
                    case JobsId.Bus:
                        ...
                        if (jobLevelInfo.Item1 <= 2 && rentCarsData.Model != "citiport" && rentCarsData.Model != "1969liaz667" ||
                            jobLevelInfo.Item1 >= 3 && jobLevelInfo.Item1 <= 4 && rentCarsData.Model != "bus" && rentCarsData.Model != "coach")
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model, jobLevelInfo.Item1), 8000);
                            return;
                        }
                    ...
                    case JobsId.CashCollector:
                        ...
                        if (jobLevelInfo.Item1 <= 2 && rentCarsData.Model != "sberbank" ||
                            jobLevelInfo.Item1 >= 3 && jobLevelInfo.Item1 <= 4 && rentCarsData.Model != "sberbank" && rentCarsData.Model != "terbyte")
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model, jobLevelInfo.Item1), 8000);
                            return;
                        }
                ...
                //string number = $"{player.Value}97";
                string number = $"{player.Value}RCAR";
                string number1 = $"{player.Value}97";
                ...
                switch (rentCarsData.Job)
                {
                    case JobsId.None:
                        ...
                        break;
                    case JobsId.Lawnmower:
                        number = VehicleManager.GenerateNumber1(VehicleAccess.Work, "");//$"LAWN-{player.Value}";
                        ...
                        break;
                    case JobsId.Taxi:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work,"");//$"TAXI-{player.Value}";
                        ...
                        break;
                    case JobsId.Bus:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "");//$"BUS-{player.Value}";
                        ...
                        break;
                    case JobsId.Trucker:
                        number = VehicleManager.GenerateNumber1(VehicleAccess.Work,"");//$"TRUCK-{player.Value}";
                    ...
                    case JobsId.CargoDelivery:
                        ...
                        break;
                    case JobsId.CashCollector:
                        number = VehicleManager.GenerateNumber1(VehicleAccess.Work, "");//$"COLLECTOR-{player.Value}";
                        ...
                        break;
                    case JobsId.CarMechanic:
                        number = VehicleManager.GenerateNumber1(VehicleAccess.Work, "");//$"MECH-{player.Value}";
                        ...
                        break;
                    case JobsId.Postman:
                        number = VehicleManager.GenerateNumber1(VehicleAccess.Work, "");//$"POSTAL-{player.Value}";
                ...
                switch (rentCarsData.Job)
                {
                    ...
                    case JobsId.Trucker:
                        ...
                        break;
                    //case JobsId.CargoDelivery:
                    //    if (rentCarsData.Model == "pounder2")
                    //    {
                    //        vehicleCreate.SetMod(11, 3);
                    //        vehicleCreate.SetMod(18, 0);
                    //        vehicleCreate.SetMod(13, 2);
                    //    }
                    //    Jobs.Repository.OnPlayerExitVehicle(player, vehicleCreate);
                    //    Jobs.CargoDelivery.StartWork(player);
                    //    break;
                    case JobsId.CashCollector:
                        Jobs.Repository.OnPlayerExitVehicle(player, vehicleCreate);
