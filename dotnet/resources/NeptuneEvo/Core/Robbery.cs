        ...
        public static void OnHouseSafe(ExtPlayer player, int _)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (player.HasSharedData("IS_MASK") && !player.GetSharedData<bool>("IS_MASK"))
                    {
                        Character.Models.WantedLevel wantedLevel = new Character.Models.WantedLevel(4, LangFunc.GetText(LangType.Ru, DataName.Police), DateTime.Now, "Ограбление сейфа");
