    ...
    class Doormanager : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
               /*
                // Banks
                {id: 0,  name: 'Pacific Standard Bank Main Doors',                     hash: 110411286,    locked: true, position: new Vector3(232.6054, 214.1584, 106.4049)},   // Right
                ...
                {id: 512, name: 'Bolingbroke Penitentiary Main Enter Third Door',      hash:  741314661,   locked: true, position: new Vector3(1795.98, 2616.696, 45.565)},  

                // Added by me
                {id: -1, name: 'Pacific Standard Bank Main Safe',                      hash: 961976194,    locked: true, position: new Vector3(254.230, 224.55, 101.87)},
               */
