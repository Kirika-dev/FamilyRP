...
namespace NeptuneEvo.Players.Phone.Gps
{
    public class Repository
    {
        ...
        public static void Init()
        {
            ...
            foreach (Vector3 item in Jobs.Bus.BusStations.Values)
                posList.Add(new List<object>
                {
                    item.X,
                    item.Y
           ...
           // funCategory.Items.Add(new GpsItem("Клуб Diamond", 945.4526f, 16.871f));
            ...
            {
                new GpsItem("Exotic DonateRoom", VehicleModel.DonateAutoRoom.NpcBuyPosition.X, VehicleModel.DonateAutoRoom.NpcBuyPosition.Y),
                new GpsItem("Elite AutoRoom", VehicleModel.EliteAutoRoom.NpcBuyPosition.X, VehicleModel.EliteAutoRoom.NpcBuyPosition.Y),
                new GpsItem("AirRoom", VehicleModel.AirAutoRoom.NpcBuyPosition.X, VehicleModel.AirAutoRoom.NpcBuyPosition.Y),
                new GpsItem("Premium Clothes Shop", -1126.9141f, -1440.1637f)
            };
            ...
            gosCategory.Items.Add(new GpsItem("Правительство", Fractions.Cityhall.GpsPosition.X, Fractions.Cityhall.GpsPosition.Y));
            gosCategory.Items.Add(new GpsItem("Армия", -294.8565f, -2605.4185f));
            gosCategory.Items.Add(new GpsItem("МВД", Fractions.Police.GunsPosition.X, Fractions.Police.GunsPosition.Y));
            gosCategory.Items.Add(new GpsItem("Больница", Fractions.Ems.emsCheckpoints[0].X, Fractions.Ems.emsCheckpoints[0].Y));
            gosCategory.Items.Add(new GpsItem("ФСБ", Fractions.Fbi.GpsPosition.X, Fractions.Fbi.GpsPosition.Y));
            gosCategory.Items.Add(new GpsItem("NEWS", LsNewsSystem.LSNewsCoords[0].X, LsNewsSystem.LSNewsCoords[0].Y));
            gosCategory.Items.Add(new GpsItem("ДПС 1", Fractions.Sheriff.FirstPosition.X, Fractions.Sheriff.FirstPosition.Y));
            ...
            {
                new GpsItem("The Families", Fractions.Manager.FractionSpawns[1].X, Fractions.Manager.FractionSpawns[1].Y),
                new GpsItem("The Ballas Gang", Fractions.Manager.FractionSpawns[2].X, Fractions.Manager.FractionSpawns[2].Y),
                new GpsItem("Los Santos Vagos", Fractions.Manager.FractionSpawns[3].X, Fractions.Manager.FractionSpawns[3].Y),
                new GpsItem("Marabunta Grande", Fractions.Manager.FractionSpawns[4].X, Fractions.Manager.FractionSpawns[4].Y),
                new GpsItem("Blood Street", Fractions.Manager.FractionSpawns[5].X, Fractions.Manager.FractionSpawns[5].Y)
            };
            ...
            {
                new GpsItem("La Cosa Nostra", Fractions.Manager.FractionSpawns[10].X, Fractions.Manager.FractionSpawns[10].Y),
                new GpsItem("Russian Mafia", Fractions.Manager.FractionSpawns[11].X, Fractions.Manager.FractionSpawns[11].Y),
                new GpsItem("Yakuza", Fractions.Manager.FractionSpawns[12].X, Fractions.Manager.FractionSpawns[12].Y),
                new GpsItem("Armenian Mafia", Fractions.Manager.FractionSpawns[13].X, Fractions.Manager.FractionSpawns[13].Y)
            };
            ...
            {
                new GpsItem("Склад", -544.56104f, -203.99673f),
                new GpsItem("Получение лицензии", 435.8382f, -984.11847f),
                new GpsItem("Семьи", -773.8519f, 312.5361f),
                new GpsItem("Фейерверки", -602.0729f, -347.30234f),
                new GpsItem("Амфитеатр", 679.7624f, 559.8024f),
                new GpsItem("Humane Labs", 3420.554f, 3758.799f),
                new GpsItem("Маяк", 3320.067f, 5169.669f),
                new GpsItem("Охотничий магазин", -827.79517f, -689.95886f),
                new GpsItem("Главный рынок", Inventory.Tent.Models.TentList.PositionGps[0].X, Inventory.Tent.Models.TentList.PositionGps[0].Y),
                new GpsItem("Черный рынок", Inventory.Tent.Models.TentList.PositionGps[1].X, Inventory.Tent.Models.TentList.PositionGps[1].Y),
                new GpsItem("Церковь", -779.12885f, -709.137f),
                new GpsItem("Продавец питомцев", 268.109f, -641.3529f),
                new GpsItem("Суд", 243.40225f, -1073.7192f),
                new GpsItem("Риэлторское агентство", -710.49f, 267.8656f),
                new GpsItem("Мебельный магазин", Houses.FurnitureManager.FurnitureBuyPos.X, Houses.FurnitureManager.FurnitureBuyPos.Y),
                new GpsItem("Почта", 132.9969f, 96.3529f),
                new GpsItem("Штрафстоянка", Fractions.Ticket.PedPos.X, Fractions.Ticket.PedPos.Y)
            };
