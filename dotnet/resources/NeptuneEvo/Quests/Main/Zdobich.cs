...
//   PedSystem.Repository.CreateQuest("Military_girl", new Vector3(-2499.8394, 3598.4458, 14.4654665), -47f, questName: "Military_girl", isBlipVisible: false);						
            ...
            switch ((zdobich_quests)line)
            {
                ...
                case zdobich_quests.Stage7:
                    ...
                    if (characterData.Licenses[1])
                        Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.CarCoupon, 1, "1970smz_s3d", addInWarehouse: false);
                    if (characterData.Licenses[2])
                        Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.CarCoupon, 1, "gaz66r", addInWarehouse: false);
                    else 
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.CarCoupon, 1, "izhjup5", addInWarehouse: false);
