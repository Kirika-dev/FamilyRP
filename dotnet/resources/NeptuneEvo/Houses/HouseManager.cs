...
namespace NeptuneEvo.Houses
{
    ...
    class HouseManager : Script
    {
        ...
        public static List<HouseType> HouseTypeList = new List<HouseType>
        {
            ...
            new HouseType(LangFunc.GetText(LangType.Ru, DataName.PremiumPlusPlus), new Vector3(-1522.9729, 142.95137, 55.668053), new Vector3(-1522.9729, 142.95137, 57.668053), 234.0f, "int_mafc_milo_"),
            new HouseType(LangFunc.GetText(LangType.Ru, DataName.Lux), new Vector3(-774.0425, 342.072, 195.7), new Vector3(-778.88, 320.96, 195.32), 255.0f, "apa_v_mp_h_05_b"),
             new HouseType(LangFunc.GetText(LangType.Ru, DataName.Osoba), new Vector3(-1522.9729, 142.95137, 55.668053), new Vector3(-1522.9729, 142.95137, 57.668053), 234.0f, "int_mafc_milo_"),
        };



        public static Vector3[] HouseHealkitPos = new Vector3[10]
        {
        ...
        private static List<int> MaxRoommates = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 0, 15, 30, 40 };
                ...
                switch (action)
                {
                    case "spawnCar":
                        ...
                        if (checkAutoInGarage)
                        {
                            if (number != null)
                            {
                                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Ваша машина будет доставлена в течении 3-x секунд", 3000);
                                NAPI.Task.Run(() => {
                                    garage.DeleteCar(number, false);
                    ...
                    case "spawn":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Spawn", 3000);
                            return;
                        }    
                        if (!isAir)
                            return;
