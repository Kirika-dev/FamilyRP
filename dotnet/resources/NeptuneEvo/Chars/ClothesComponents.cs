        ...
        public void OnResourceStart()
        {
            ...
            using (var db = new ConfigBD("ConfigDB"))
            {
                try
                {
                    ...
                    Console.WriteLine("=== Загруженные маски ===");
foreach (var mask in clothesComponentData[true][ClothesComponent.Masks])
{
                        Console.WriteLine($"[MASK] ID: {mask.Key}, Name: {mask.Value.TName}, Variation: {mask.Value.Variation}");
}
                    //  
        ...
        public static IReadOnlyDictionary<bool, Dictionary<ClothesComponent, int>> MaxClothesComponent = new Dictionary<bool, Dictionary<ClothesComponent, int>>()
        {
            { true, new Dictionary<ClothesComponent, int>()
                {//Man 
                    { ClothesComponent.Hat, 251 }, //+
                    { ClothesComponent.Torsos, 214 },
                    { ClothesComponent.Legs, 249 },  //+
                    { ClothesComponent.Shoes, 205 }, //+
                    { ClothesComponent.Accessories, 219 }, //+
                    { ClothesComponent.BodyArmors, 62 },
                    { ClothesComponent.Tops, 648 }, // +
                    { ClothesComponent.Undershirts, 215 },
                    { ClothesComponent.Masks, 260 },//+
                    { ClothesComponent.Ears, 42 },
                    { ClothesComponent.Watches, 34}, //+
                    { ClothesComponent.Glasses, 59 },

                    { ClothesComponent.Bugs,131 },

                    { ClothesComponent.Bracelets, 16 },

                    { ClothesComponent.Decals, 246 },
                }
            },
            { false, new Dictionary<ClothesComponent, int>()
                {
                    { ClothesComponent.Hat, 239 }, //+
                    { ClothesComponent.Torsos, 248 },
                    { ClothesComponent.Legs, 259 },  //+
                    { ClothesComponent.Shoes, 207 }, //+
                    { ClothesComponent.Accessories, 201 }, //a
                    { ClothesComponent.BodyArmors, 62 },
                    { ClothesComponent.Tops, 681 }, //+
                    { ClothesComponent.Undershirts, 261 },
                    { ClothesComponent.Masks,  267}, //+
                    { ClothesComponent.Ears, 23 },
                    { ClothesComponent.Watches, 38 }, //+
                    { ClothesComponent.Glasses, 67 }, //+

                    { ClothesComponent.Bugs, 121 },
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (isCharacterData)
                    {
                        ...
                        var MaskData = ClothesComponentData[gender][Chars.ClothesComponent.Masks];
        ...
        public static IReadOnlyDictionary<bool, Dictionary<BarberComponent, int>> MaxBarberComponent = new Dictionary<bool, Dictionary<BarberComponent, int>>()
        {
            { true, new Dictionary<BarberComponent, int>()
                {//Man 
                    { BarberComponent.Hair, 182 },
                    { BarberComponent.Beard, 185 },
        ...
        private void LoadBarber()
        {
            using (var db = new ConfigBD("ConfigDB"))
            {
                ...
                Console.WriteLine("=== Загруженные бороды ===");
foreach (var beard in barberComponentData[true][BarberComponent.Beard])
{
                    Console.WriteLine($"[BEARD] ID: {beard.Key}, Name: {beard.Value.TName}, Variation: {beard.Value.Variation}");
}
