...
namespace NeptuneEvo.Chars
{
    class Stock : Script
    {
        ...
        public void Init()
        {
            try
            {
                Main.CreateBlip(new Main.BlipData(478, "Хранилище 'GoPostal'", new Vector3(62.398926, 108.00354, 79.07767), 32, true));
                ...
                PedSystem.Repository.CreateQuest("s_m_m_postal_01", new Vector3(62.398926, 108.00354, 79.07767), -151.96516f, 0, title: "~y~NPC~w~ Почтальон Александр\nСклад посылок", colShapeEnums: ColShapeEnums.Warehouse);
            }
            catch (Exception e)
            {
