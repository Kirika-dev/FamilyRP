...
namespace NeptuneEvo.AleSystems.Fishing.Data
{
    public class Config
    {
        ...
        {
             new FishItemData(ItemId.Sterlad, minLvl: 0, chance: 50, minPrice: 7000, maxPrice: 18500),
             new FishItemData(ItemId.Losos, minLvl: 0, chance: 50, minPrice: 8500, maxPrice: 19500),
             new FishItemData(ItemId.Osetr, minLvl: 0, chance: 50, minPrice: 9000, maxPrice: 20000),
             new FishItemData(ItemId.BlackAmur, minLvl: 0, chance: 50, minPrice: 9500, maxPrice: 22700),
             new FishItemData(ItemId.Skat, minLvl: 0, chance: 40, minPrice: 10000, maxPrice: 25000),
             new FishItemData(ItemId.Tunec, minLvl: 0, chance: 38, minPrice: 11000, maxPrice: 27000),
             new FishItemData(ItemId.Malma, minLvl: 0, chance: 35, minPrice: 12000, maxPrice: 30000),
             new FishItemData(ItemId.Fugu, minLvl: 0, chance: 30, minPrice: 100, maxPrice: 1500, rods: new List<ItemId>() { ItemId.RodMk2 }, isDonate: true),
        };
            ...
            new StorePlace("Рыболовный магазин", position: new Vector3(1533.448, 3779.9336, 34.51497), heading: -151, blipSprite: 356, blipColor: 38, (uint)PedHash.OldMan2, 
                new Dictionary<string, List<StoreItem>>()
                {
                    { "fishingCategoryRod", new List<StoreItem>() {
                        new StoreItem("Удочка", ItemId.Rod, minPrice: 11000, maxPrice: 20000, value: 1),
                        new StoreItem("Удочка улучш.", ItemId.RodUpgraded, minPrice: 27000, maxPrice: 41000, value: 1),
                        new StoreItem("Удочка Mk2", ItemId.RodMk2, minPrice: 50000, maxPrice: 78000, value: 1),
                    }},
