...
namespace NeptuneEvo.Fractions
{
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                NAPI.TextLabel.CreateTextLabel("Аморя Аесон", new Vector3(-2348.598, 3210.923, 29.224812), 5f, 0.3f, 4, new Color(255, 255, 255), false);
                NAPI.TextLabel.CreateTextLabel("ЗАПРАВКА ВОЗДУХ", new Vector3(-2145.1223, 3018.961, 33.080303), 5f, 0.3f, 4, new Color(255, 255, 255), false);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[0], 1, 2, 0, ColShapeEnums.FractionArmy, 0);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"), new Vector3(ArmyCheckpoints[0].X, ArmyCheckpoints[0].Y, ArmyCheckpoints[0].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[1], 1, 2, 0, ColShapeEnums.FractionArmy, 1);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"), new Vector3(ArmyCheckpoints[1].X, ArmyCheckpoints[1].Y, ArmyCheckpoints[1].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[2], 50, 60, 0, ColShapeEnums.FractionArmy, 2);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Открыть оружейный склад"), new Vector3(ArmyCheckpoints[5].X, ArmyCheckpoints[5].Y, ArmyCheckpoints[5].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                //NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие"), new Vector3(ArmyCheckpoints[9].X, ArmyCheckpoints[9].Y, ArmyCheckpoints[9].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));


                CreateCylinderColShape(ArmyCheckpoints[11], 1, 2, 0, ColShapeEnums.VorotaArmy, 0);
                //NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие"), new Vector3(ArmyCheckpoints[10].X, ArmyCheckpoints[10].Y, ArmyCheckpoints[10].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                CreateCylinderColShape(ArmyCheckpoints[12], 1, 2, 0, ColShapeEnums.VorotaArmy, 0);
                //CustomColShape.CreateCylinderColShape(ArmyCheckpoints[11], 1, 2, 0, ColShapeEnums.FractionArmy, 10);
                //NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Вызвать сотрудника'"), new Vector3(ArmyCheckpoints[11].X, ArmyCheckpoints[11].Y, ArmyCheckpoints[11].Z), 5F, 0.3F, 0, new Color(255, 255, 255));

                CreateCylinderColShape(ArmyCheckpoints[13], 1, 2, 0, ColShapeEnums.VorotaArmy, 1);
                //NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"), new Vector3(ArmyCheckpoints[12].X, ArmyCheckpoints[12].Y, ArmyCheckpoints[12].Z), 5F, 0.3F, 0, new Color(255, 255, 255));
                //Main.CreateDoorsColshape(new Vector3(-2304.4167, 3388.3845, 31.25652), 2.0f, new List<string> { "army_22", "army_23" });
                //CreateCylinderColShape(VorotaPosition, 1, 1, 0, ColShapeEnums.VorotaArmy, 0);
                //NAPI.Marker.CreateMarker(1, VorotaPosition - new Vector3(0, 0, 0.27), new Vector3(), new Vector3(), 0.80f, new Color(255, 255, 255, 220));
                ...
                //NAPI.Marker.CreateMarker(1, new Vector3(-2304.4167, 3388.3845, 31.25652) - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[13] , new Vector3(0, 0, 0.7), new Vector3(), 1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[11], new Vector3(0, 0, 0.7), new Vector3(), 1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[12], new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));
                //NAPI.Marker.CreateMarker(21, ArmyCheckpoints[12], new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));

                Main.SetBlipTransparency(new Vector3(-2318.775f, 3325.0476f, 31.712816f), 0); // Скрыть блип для бизнеса с указанной позицией
                Main.CreateBlip(new Main.BlipData(305, "ВЧ 25489", new Vector3(-2062.0103, 3196.759, 32.795883), 4, true));
                Main.HideBusinessBlip(new Vector3(-2145.1223, 3018.961, 33.080303)); // Скрыть блип для бизнеса с указанной позицией
            ...
            PedSystem.Repository.CreateQuest("s_m_y_marine_01", ArmyCheckpoints[9], -118.38985f, title: "~y~NPC~w~ Рекрут Астраханский\nВыдача оружия", colShapeEnums: ColShapeEnums.FractionArmyGuns);
            PedSystem.Repository.CreateQuest("s_m_y_marine_01", ArmyCheckpoints[10], -118.41277f, title: "~y~NPC~w~ Рекрут Астраханский\nВыдача оружия", colShapeEnums: ColShapeEnums.FractionArmyGuns);
        }
            catch (Exception e) { Log.Write("ResourceStart: " + e.Message, nLog.Type.Error); }
        }
        //public static Vector3 VorotaPosition = new Vector3(-2304.4167, 3388.3845, 31.25652);
        private static readonly nLog Log = new nLog("Fractions.Army");        

        public static Vector3[] ArmyCheckpoints = new Vector3[14]
        {
            new Vector3(-2349.2397, 3217.694, 28.5), // guns     0
            new Vector3(-2340.1667, 3223.0715, 28.5), // dressing room    1
            new Vector3(1366.2473, 3156.52, 39.0), // army docks mats     2
            ...
            new Vector3(-2470.2588, 3316.4607, 32.98206), // GTA5RP склад оружия  9
            new Vector3(-2346.9763, 3269.4868, 32.810787), // RedAge склад оружия 10
            new Vector3(-2304.4167, 3388.3845, 31.25652), // Открыть ворота КПП2 11
            new Vector3(-2319.4045, 3399.2556, 30.738352), // Вызов сотрудника КПП2  12
            new Vector3(-1590.6038, 2795.7024, 17.071465), // Открыть ворота КПП1  13
        };
                ...
                switch (interact)
                {
                    ...
                    case 2:
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            sessionData.TimersData.LoadMatsTimer = Timers.StartOnce(10000, () => loadMaterialsTimer(player), true);
        ...
        public static bool VorotaArmy = false;
        public static bool VorotaArmy2 = false;

        [Interaction(ColShapeEnums.VorotaArmy)]

        public static void Vorota_Army(ExtPlayer player, int index)
        {
            try
            {
                var sessionData = player.GetSessionData();
                ...
                {
                    case 0:
                        if (fractionData != null && fractionData.Id == (int)Models.Fractions.ARMY)
                        {
                            // Если игрок - сотрудник армии, то управляем воротами
                            if (VorotaArmy)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Ворота закрыты.", 3000);
                                Trigger.ClientEvent(player, "client.armyKPP2.close.gate");
                                return;
                            }

                            Trigger.ClientEvent(player, "client.armyKPP2.open.gate");
                            Commands.RPChat("sme", player, $"открыл ворота на 60 секунд.");
                            VorotaArmy = true;
                        ...
                        {
                            // Если игрок не из армии, то открываем диалог вызова
                            if (sessionData.CuffedData.Cuffed)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.IsCuffed), 3000);
                                return;
                    ...
                    case 1:
                        {
                            if (fractionData != null && fractionData.Id == (int)Models.Fractions.ARMY)
                            {
                                if (VorotaArmy2)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Вторые ворота закрыты.", 3000);
                                    Trigger.ClientEvent(player, "client.armyKPP1.close.gate");
                                    return;
                                }
                                Trigger.ClientEvent(player, "client.armyKPP1.open.gate");
                                Commands.RPChat("sme", player, $"открыл ворота на 60 секунд.");
                                VorotaArmy2 = true;
            ...
            {
                Log.Write($"Vorota_Army Exception: {e}");
            }
        }
        public static void Vorota_Army2(ExtPlayer player)
        {
            try
            {
                var sessionData = player.GetSessionData();
        ...
        [Interaction(ColShapeEnums.FractionArmyGuns)]
        public static void OnFractionArmyGuns(ExtPlayer player, int interact)
        {
            try
            {
                var sessionData = player.GetSessionData();
        ...
        public static void loadMaterialsTimer(ExtPlayer player)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (vehicle.Model == (uint)VehicleHash1.mi8cargo)
                    {
                        if (Stocks.CargobobMats == 0) // Если Cargobob больше не может загрузить материалы
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.CargobobDayLimit, Stocks.MaxCargobobMats), 3000);
