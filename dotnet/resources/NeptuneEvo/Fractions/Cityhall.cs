...
{ 
    ...
    { 
        ...
        public static Vector3 CloakroomPosition = new Vector3(-572.5503, -201.5045, 42.703773f); 
        public static Vector3 SecondCloakroomPosition = new Vector3(2522.4473f, -330.00107f, 94f); 
        private static Vector3 StockPosition = new Vector3(-573.6708, -199.76015, 42.702656f); 
        public static Vector3 GiveGunPosition = new Vector3(-574.78015, -197.86638, 42.7016f); 
        public static Vector3 SecondGiveGunPosition = new Vector3(2487.9102f, -376.6428f, 82.69f); 
        public static Vector3 GpsPosition = new Vector3(-545.02136, -204.28348, 38.2); 
        private static Vector3 CallingEmployeesPosition = new Vector3(-1289.8119, -572.5035, 30.573f);

        private static Vector3 JobPosition = new Vector3(-551.63495, -190.0685, 38.21967);
        ...
        { 
            try 
            {
                Main.CreateBlip(new Main.BlipData(419, "Мэрия", GpsPosition, 4, true, 1.5f));
                ...
                PedSystem.Repository.CreateQuest("a_f_y_business_04", new Vector3(-552.79065, -190.72388, 38.21967), -148.24094f, title: "~y~NPC~w~ Сара Каримова\nВызвать сотрудника", colShapeEnums: ColShapeEnums.CallGovMember);
                PedSystem.Repository.CreateQuest("DeadpoolMovie", GiveGunPosition, 161.40262f, title: "~y~NPC~r~ Дэдпул Обаяшка\nВыдача оружия", colShapeEnums: ColShapeEnums.FractionCityhallGunMenu);
